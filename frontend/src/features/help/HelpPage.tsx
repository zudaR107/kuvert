...
const SECTIONS: Section[] = [
  ...
  {
    titel: 'Настройки',
    text: 'Здесь задаётся основная валюта данных Kuvert. Формат даты и первый день недели берутся из профиля Schlüssel: Kuvert показывает их здесь, а изменить их можно на странице аккаунта Schlüssel через значок профиля в шапке.',
